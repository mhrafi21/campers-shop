        ...
        <div className="px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700">
              Address: 123 Camping St, Adventure City, USA
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-700">
              ...
              gear that enhances your outdoor adventures. We believe in
              sustainability, durability, and creating products that make your
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg overflow-hidden shadow-md p-4">
                ...
                <p className="text-gray-600">
                  John is an avid camper with over 20 years of experience in the
                  outdoor industry. He started Campers Shop to share his passion
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-md p-4">
                ...
                <p className="text-gray-600">
                  Jane leads our marketing team with creativity and enthusiasm.
                  She ensures our message reaches campers around the world.
                </p>
              </div>
              <div className="bg-white rounded-lg overflow-hidden shadow-md p-4">
                <img
                ...
                <p className="text-gray-600">
                  Bob has a keen eye for design and functionality. He is
                  dedicated to creating innovative camping gear that meets the
